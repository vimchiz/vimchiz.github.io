...
window.onload = function () {
  setTimeout(function () {
    $("#other_tab").addClass("focus");
    /**
     * Hover in
     */
    $("#other_tab").hover(function () {
        $("#other_tab").css("background-color", "#fec503");
        $("#other_tab").css("color", "#fff");
       ...
       */
      function () {
        $("#other_tab").css("background-color", "#fed136");
        $("#other_tab").css("color", "#fff");
      });
  }, 500);
};